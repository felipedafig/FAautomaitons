export const en = {
  page: {
    ...
    box3: {
      ...
      savedPerWeek: "avg. saved per week",
      reviewImprovement: "avg. review improvement",
    },
    box4: {
      title: "Seamless integrations",
      subtitle: "| 350+ apps connected",
    },
    testimonials: {
  ...
  team: {
    subtitle: "The people behind the automation",
    title: "Meet our team",
    description:
